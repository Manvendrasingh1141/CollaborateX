...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:3001"}/user/${user.email}/boards`)
  ...
  const handleSave = () => {
    ...
    axios.put(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:3001"}/user/${user.email}`, { firstname, lastname, photo })
      .then(res => {
